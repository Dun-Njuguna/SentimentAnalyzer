  ...
  const navs = [
    {
      ...
      redirect: "https://www.ecommerce-app.com/communication-preferences/push",
    },
    {
      title: "Sell on ecommerce-app",
      icon: <BusinessCenterIcon sx={{ fontSize: "18px" }} />,
      redirect: "https://seller.ecommerce-app.com/sell-online",
    },
    {
      title: "24x7 Customer Care",
      icon: <LiveHelpIcon sx={{ fontSize: "18px" }} />,
      redirect: "https://www.ecommerce-app.com/helpcentre",
    },
    {
      title: "Advertise",
      icon: <TrendingUpIcon sx={{ fontSize: "18px" }} />,
      redirect: "https://advertising.ecommerce-app.com",
    },
    {
      title: "Download App",
      icon: <DownloadIcon sx={{ fontSize: "18px" }} />,
      redirect: "https://www.ecommerce-app.com/mobile-apps",
    },
  ];
