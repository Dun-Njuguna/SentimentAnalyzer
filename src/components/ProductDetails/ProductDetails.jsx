    ...
    <>
      {loading ? (
        ...
        <>
          ...
          {/* <MinCategory /> */}
          <br />
          <main className='pt-10 mt-12 sm:mt-0 '>
                  ...
                  <div className='w-full flex gap-3'>
                    ...
                    {product.stock > 0 && (
                      <button
                        ...
                        className='p-4 w-1/2 flex items-center justify-center gap-2 text-white bg-primary-darkBlue rounded-sm shadow hover:shadow-lg'
                      >
                        <ShoppingCartIcon />
                    ...
                    <button
                      ...
                      className={
                        product.stock < 1
                          ? "p-4 w-full flex items-center justify-center gap-2 text-white bg-primary-darkBlue cursor-not-allowed rounded-sm shadow hover:shadow-lg"
                          : "p-4 w-1/2 flex items-center justify-center gap-2 text-white bg-primary-darkBlue rounded-sm shadow hover:shadow-lg"
                      }
                    >
                      <FlashOnIcon />
                  ...
                  <div className='w-full mt-4 rounded-sm border flex flex-col'>
                    <div className='flex justify-between items-center border-b px-6 py-4'>
                      ...
                      <button
                        ...
                        className='shadow bg-primary-darkBlue text-white px-4 py-2 rounded-sm hover:shadow-lg'
                      >
                        Rate Product
                      </button>
                    </div>
