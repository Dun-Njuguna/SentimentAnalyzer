...
const Shipping = () => {
  ...
  return (
    <>
      <MetaData title='ecommerce-app: Shipping Details' />
            ...
            <Stepper activeStep={1}>
              <div className='w-full bg-white'>
                ...
                >
                  ...
                  <button
                    type='submit'
                    className='bg-primary-darkBlue w-full sm:w-1/3 my-2 py-3.5 text-sm font-medium text-white shadow hover:shadow-lg rounded-sm uppercase outline-none'
                  >
