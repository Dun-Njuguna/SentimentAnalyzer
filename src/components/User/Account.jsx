              ...
              <div className='flex-1 overflow-hidden shadow bg-white'>
                ...
                <div className='flex flex-col gap-12 m-4 sm:mx-8 sm:my-6'>
                  ...
                  <div className='flex flex-col gap-4 mt-4'>
                    ...
                    <h4 className='text-sm font-medium'>
                      When will my ecommerce-app account be updated with the new
                    ...
                    <h4 className='text-sm font-medium'>
                      What happens to my existing ecommerce-app account when I
                    ...
                    <p className='text-sm'>
                      ecommerce-app has a 'single sign-on' policy. Any changes
